...
class ResponsesApiTransport(ProviderTransport):
    ...
    def build_kwargs(
        ...
        **params,
        ...
        try:
            from run_agent import DEFAULT_AGENT_IDENTITY  # noqa: F811
        ...
        kwargs = {
            ...
            "tools": _responses_tools(tools) if tools is not None else _responses_tools(tools),
            "tool_choice": "auto",
    ...
    def validate_response(self, response: Any) -> bool:
        """Check Codex Responses API response structure."""
        if response is None:
            return False
